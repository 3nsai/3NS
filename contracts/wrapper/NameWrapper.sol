    ...
    ReverseClaimer
{
    ...
    bytes32 private constant ETH_LABELHASH =
        0x906f4bd26db04205451741914e3591af122a9ecb412fd5a0a8e0146b48a9d4c6; // web3 label hash
    ...
    function _wrapETH2LD(
        ...
        bytes memory name = _addLabel(label, "\x03web3\x00");
        names[node] = name;
