...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log("ENS Registry: ", registry.address);
  ...
  if (network.name !== 'hardhat' && network.name !== 'localhost') {
    ...
    try {
      ...
      console.log("ReverseRegistrar Contract verified successfully!");
    } catch (err) {
      console.log("ReverseRegistrar Verification failed:", err);
    }
